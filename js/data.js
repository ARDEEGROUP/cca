...
"JODHAIYA BAI BAIGA": {
  ...
  "DURGA BAI VYAM": {
    ...
    "1. This vibrant painting by Durga Bai Vyom captures a bustling ceremonial scene deeply rooted in Pardhan Gond tradition. At the center is a large, elaborately adorned animal—a mythical or symbolic creature—decorated with intricate patterns and vivid colors. Surrounding it are numerous human figures in animated poses, suggesting a festive gathering filled with music, dance, and ritual. Many of the figures hold instruments or ceremonial objects, dressed in detailed, colorful attire that enhances the sense of festivity. The composition overflows with movement and rhythm, each element contributincolorfulisual narrative that celebrates communal life, oral traditions, and the sacred connection between humans, animals, and the natural world.",
 "2. This striking vertical composition by Durga Bai Vyom portrays a symbolic ritual scene set against a dark, textured background. At the center is a prominent stylized vessel, from which water flows downward into a larger container or body, signifying themes of sustenance, purification, or ancestral offering. Human figures are embedded within the scene, with one figure on the right actively engaged— offering a lamp or tending to the flow of water—evoking a sense of sacred participation. Bold, flat colors—particularly blues, yellows, reds, and greens—are used with precision, enhancing the visual power of the work. The detailed patterns and delicate motifs, such as leaves and natural forms scattered throughout, are hallmarks of Gond art, enriching the composition with layered symbolism and spiritual resonance.",

    ],
    paintings: ["images/durgaone.jpeg"]
  },
...
"2. Set beneath a canopy of lush green trees, this dynamic painting portrays a bustling market or communal gathering. Human figures and animals—likely oxen or cattle—interact in a lively outdoor space. Yellow shapes scattered across the ground suggest fallen fruit or produce, reinforcing the agrarian setting. Executed in a vibrant folk style with flat colors and strong outlines, the figures are shown in motion, engaged in trade, conversation, or work. The scene radiates a sense of collective rhythm, rooted in nature and shared experience.",
    ...
    paintings: ["images/gangaone.jpeg" , "images/gangatwo.png"]
  },
